      ...
      <div class="clearfix"></div>
        ...
        <div class="col-sm-4">
            <div class="form-group">
                <br>
                <label>
                    {!! Form::checkbox('is_accessories', 1, !empty($duplicate_product) ? $duplicate_product->is_accessories : true, ['class' => 'input-icheck', 'id' => 'is_accessories']); !!} <strong>@lang('product.is_accessories')</strong>
                </label>
            </div>
        </div>
        <div class="clearfix"></div>
